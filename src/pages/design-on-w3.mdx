...
Codenamed Project Singularity, the intention around the redesign of the digital
property w3.ibm.com/design was to be a collection or aggregration of resources
that an IBM designer could easily leverage.

</PageDescription>


<AnchorLinks>
  <AnchorLink>Pain Points</AnchorLink>
  <AnchorLink>Hills</AnchorLink>
  <AnchorLink>The Outcome</AnchorLink>
  <AnchorLink>What I Learned</AnchorLink>
</AnchorLinks>
...
You should always start a new project by pulling upstream changes into master
and then creating a new branch. This workflow ensures you don’t accidentally
commit anything to your master branch and get stuck when trying to open a pull
request.
...
[variables](https://github.com/carbon-design-system/carbon/blob/master/packages/components/src/globals/scss/_vars.scss):
